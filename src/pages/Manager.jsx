...
import ManagerBookingManagement from '../components/manager/BookingManagement'
...
export default function Manager() {
  ...
  const createFloatingIcon = () => {
    const iconComponents = [Map, BarChart3, DollarSign, Calendar, Users, MessageSquare];
  ...
  const getGlowGradient = () => {
    ...
    return `radial-gradient(circle at ${centerX}% ${centerY}%, rgba(79, 70, 229, 0.1) 0%, rgba(99, 102, 241, 0.05) 25%, rgba(0, 0, 0, 0) 50%)`;
  };
  ...
  const tabs = [
    { id: 'tours', name: 'Туры', icon: Map, color: 'from-indigo-500 to-blue-600' },
    { id: 'dates', name: 'Даты туров', icon: Calendar, color: 'from-green-500 to-emerald-600' },
    { id: 'bookings', name: 'Бронирования', icon: Users, color: 'from-purple-500 to-indigo-600' },
    { id: 'payments', name: 'Платежи', icon: DollarSign, color: 'from-amber-500 to-yellow-600' },
    { id: 'reviews', name: 'Отзывы', icon: MessageSquare, color: 'from-rose-500 to-pink-600' },
    { id: 'analytics', name: 'Статистика', icon: BarChart3, color: 'from-cyan-500 to-blue-600' }
  ]
      ...
      <div className="flex items-center justify-center min-h-[70vh]">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-600">У вас нет прав для доступа к панели менеджера</p>
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {floatingIcons.map((icon) => {
          ...
          return (
            <motion.div 
              key={icon.id}
              className="absolute pointer-events-none z-10 text-indigo-200/30"
              initial={{ 
                opacity: 0, 
                x: `${icon.x}%`, 
                y: `${icon.y}%`,
      ...
      <AnimatePresence>
        {showNotification && (
          <motion.div 
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed top-5 left-1/2 -translate-x-1/2 z-50 rounded-lg px-5 py-4 bg-indigo-500/90 backdrop-blur-sm text-white shadow-lg flex items-center"
          >
      ...
      <div className="text-center mb-12">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute inset-0 rounded-full bg-gradient-to-br from-indigo-400/20 to-blue-500/20 blur-lg"
          />
          ...
          <motion.div 
            ...
            style={{
              background: 'conic-gradient(from 0deg, rgba(99, 102, 241, 0), rgba(99, 102, 241, 0.7), rgba(59, 130, 246, 0.7), rgba(99, 102, 241, 0))'
            }}
            animate={{ rotate: 360 }}
        ...
        <motion.h1
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-blue-600 mb-3"
        >
          Панель менеджера
        </motion.h1>
      ...
      >
        ...
        {/* Блестящая рамка */}
        <div className="absolute inset-0 rounded-2xl p-[1px] bg-gradient-to-br from-indigo-400/30 via-transparent to-blue-500/30 pointer-events-none"></div>
          ...
          {tabs.map((tab, index) => (
            <motion.button
              ...
              className={`relative rounded-xl px-4 py-3 flex items-center ${
                activeTab === tab.id ? 'text-white' : 'text-gray-700 hover:text-indigo-600'
              }`}
              whileHover={{ y: -3 }}
              whileTap={{ scale: 0.97 }}
            >
      ...
      >
        ...
        {/* Случайные блики */}
        <div className="absolute -top-60 -right-60 w-96 h-96 bg-indigo-400/5 rounded-full blur-3xl pointer-events-none"></div>
        <div className="absolute -bottom-60 -left-60 w-96 h-96 bg-blue-500/5 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div className="relative p-6 z-10">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {activeTab === 'bookings' && <ManagerBookingManagement />}
      ...
      >
        <div className="flex items-center">
          ...
          <span>Режим менеджера</span>
        </div>
        
        <div className="flex items-center">
          <Settings className="w-4 h-4 mr-1.5 text-indigo-500" />
